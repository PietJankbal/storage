...
#//    New-ItemProperty -Path 'HKCU:\\Software\\Wine\\DllOverrides' -force -Name 'mscoree' -Value 'native' -PropertyType 'String'
    ...
    #Start-Process expand.exe -ArgumentList 'Windows6.1-KB3191566-x64.cab','-F:System.Management.Automation.dll','.'
    #$expandid = (Get-Process expand).id; Wait-Process -Id $expandid;
#    Copy-Item -Path msil_*/System.Management.Automation.dll -Destination $env:SystemRoot\\system32\\WindowsPowerShell\\v1.0\\System.Management.Automation.dll
